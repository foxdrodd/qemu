...
Reuses the vendored dcboot.py harness (tests/dreamcast/dcboot.py). Point
$DC_HARNESS at another scripts/ dir to override.
...
# Vendored in-repo (tests/dreamcast/dcboot.py) so this runs outside this one
# machine; $DC_HARNESS still overrides for a local out-of-tree copy.
...
from dc_test_utils import need, has, parse_ppm, ppm_distinct_pixels, wav_peak
